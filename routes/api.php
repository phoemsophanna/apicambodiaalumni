...
Route::prefix('/web')->group(function () {
    ...
    Route::post("/update-donation/{transactionId}", [Website\DonationController::class, "checkOrder"]);
...
Route::get("/member-count", [Website\HomepageController::class, "countMember"]);
...
Route::group(['middleware' => 'auth:api', 'prefix' => 'user-donation'], function () {
    Route::get("/donorlist/{id}", [Website\DonationController::class, "donorListUser"]);
});
